...
\u2705 ${prefix}-engine: ${localVersion} (up to date)`);
  ...
  static getDefaultBinDir() {
    const __filename = typeof import_meta !== "undefined" && import_meta.url ? (0, import_url.fileURLToPath)(import_meta.url) : "";
    const __dirname = __filename ? (0, import_path.dirname)(__filename) : process.cwd();
    const possibleDirs = [
